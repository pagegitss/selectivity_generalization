...
def main():
	...
	parser.add_argument("--epochs", help="number of epochs (default: 70)", type=int, default=70)
	parser.add_argument("--batch", help="batch size (default: 200)", type=int, default=200)
